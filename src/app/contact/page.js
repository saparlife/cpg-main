          ...
          <div className="lg:w-3/5 relative">
            ...
            <div className="relative z-10 p-8 lg:p-12">
              <div className="text-center">
                ...
                {/* Second Big Text */}
                <div>
                  <h3 className="text-8xl font-black uppercase text-white font-gothamultra">{t("contact.create")}</h3>
                </div>
          ...
          <div className="lg:w-2/5">
            <div className="p-8 lg:p-10">
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Name Input */}
                <div>
                  <label htmlFor="name" className="block text-white font-gothammedium text-sm mb-2">
                    {t("contact.name")}
                  </label>
                  <input
                    id="name"
                ...
                {/* Email Input */}
                <div>
                  <label htmlFor="email" className="block text-white font-gothammedium text-sm mb-2">
                    {t("contact.email")}
                  </label>
                  <input
                    id="email"
                ...
                <div className="relative">
                  <label htmlFor="service" className="block text-white font-gothammedium text-sm mb-2">
                    {t("contact.service")}
                  </label>
                  <select
                    id="service"
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                    <svg className="w-5 h-5 text-white mt-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Message Textarea */}
                <div>
                  <label htmlFor="message" className="block text-white font-gothammedium text-sm mb-2">
                    {t("contact.message")}
                  </label>
                  <textarea
                    id="message"
                ...
                >
                  {loading && <LoaderCircle className={`inline-block mr-2 animate-spin text-black`} size={24} />}
                  {t("contact.send")}
                </button>
              </form>
            </div>
